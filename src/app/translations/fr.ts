...
export default {
    ...
    'component.refresh-package.all': 'Actualiser tous les packages de chaque dépôt',
    'component.refresh-package.all.force': 'Forcer l\'actualisation de tous les packages de chaque dépôt',
    'component.refresh-package.one': 'Actualiser les packages',
    'component.refresh-package.one.force': 'Forcer l\'actualisation des packages',
    'component.refresh-package.one.version': 'Actualiser le package',
    'component.refresh-package.one.version.force': 'Forcer l\'actualisation du package',
    'component.refresh-package.cache.all': 'Actualiser uniquement le cache des packages de chaque dépôt',
    'component.refresh-package.cache.one': 'Actualiser uniquement le cache des packages',
    ...
    'views.repositories.remove-confirmation': 'Voulez-vous vraiment supprimer définitivement le dépôt ?',
    ...
    'views.packages.remove-confirmation': 'Voulez-vous vraiment supprimer tous les packages du dépôt ?',
    ...
    'views.settings.github.oauth-token': 'Jeton oAuth',
    'views.settings.github.oauth-token.description': 'Utilisé pour connecter Tug à votre compte Github',
    'views.settings.github.webhook-token': 'Jeton de webhook',
    'views.settings.github.webhook-token.description': 'Utilisé pour connecter les webhook Github à Tug',
    'views.settings.gitlab': 'Gitlab',
    'views.settings.gitlab.oauth-token': 'Jeton oAuth',
    'views.settings.gitlab.oauth-token.description': 'Utilisé pour connecter Tug à votre compte Gitlab',
    'views.settings.gitlab.webhook-token': 'Jeton de webhook',
    'views.settings.gitlab.webhook-token.description': 'Utilisé pour connecter les webhook Gitlab à Tug',
